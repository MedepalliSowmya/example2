...
export default class RecDeposit extends React.Component{
    constructor()
    {
        super();
        this.state={
        ...
        this.recFix=this.recFix.bind(this);
        }
        setYear(event)
        {
            this.setState({
       ...
       recFix()
       {
           ...
           this.recdep=this.amount*Math.pow((1+this.r),this.year);
           alert("your Maturity Amount is:"+ this.recdep);
       }
       render(){
           return(
               <div>
                   ...
                   <button onClick={this.recFix}>Recurring Deposit</button>
               </div>
           )
       }
